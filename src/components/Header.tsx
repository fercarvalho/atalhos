...
const Header = () => {
  ...
  return (
    <header className="bg-card border-b border-border shadow-sm">
      ...
      {showFloatingSearch && (
        <div className="fixed top-[1.5rem] left-1/2 z-50 w-11/12 max-w-sm -translate-x-1/2 scale-90 md:w-[300px] md:scale-100 bg-card rounded-xl shadow-lg px-2 py-2 flex items-center">
